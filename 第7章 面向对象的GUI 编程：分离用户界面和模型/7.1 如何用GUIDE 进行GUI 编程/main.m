...
set(handles.inputbox,'string','0.00');    %用户input box 切值
set(handles.balancebox,'string','500.00');% balance box 初值
setappdata(handles.output,'balance',500); % 把balance值放大appdata里面
...
% 得到input box 中的用户输入， 并且转成donble
% 从appdata 中得到balance值， 并且和input box做减法。
% 更新appdata 中的balance值， 最后更新界面上的balance的显示。
